    ...
    getOne: async function (id) {
        try {
            ...
            if(data.status===200){
                ...
                document.getElementById('username').value = data.learner.username
                document.getElementById('document').value = data.learner.document
    ...
    function validaciones() {
        ...
        email.oninput = function () {
            ...
            if (emailRegex.test(this.value)) {
                ...
                document.getElementById('emailMessage').innerHTML = "Este campo es requerido"
                this.classList.add('is-invalid');
                btnForm.setAttribute('disabled', 'disabled');
                estado[2] = 'no';
            }
