<nav class="navbar navbar-expand-lg navbar-light bg-white" style="box-shadow: 0 0.125rem 0.25rem rgba(0, 0, 0, 0.075)">
    <div class="container">
        <a class="navbar-brand" href="<?php echo constant('URL') ?>dashboard"><?php echo constant('APPNAME'); ?></a>
                ...
                <ul class="navbar-nav ml-auto">
                    <li class="nav-item dropdown">
                        ...
                        <div class="dropdown-menu dropdown-menu-right" aria-labelledby="navbarDropdown">
                            <a class="dropdown-item" href="<?php echo constant('URL') ?>reports">Reportes</a>
